        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{Route('ind_Clt')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Enregistrer un client</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{Route('liste_Clt')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{Route('ind_Cmd')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Prendre une commande</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{Route('liste_Cmd')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{Route('liste_reglem')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{Route('liste_Prdt')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
